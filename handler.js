...
"headerType": "DOCUMENT", "documentMessage": {
  ...
  }}, 'buttonsMessage', { quoted: false, contextInfo: { mentionedJid: [user], forwardingScore: 999, isForwarded: true, externalAdReply: { title: global.wm, body: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar', description: action === 'add' ? 'Selamat Datang Kak!' : 'Yahh.. kok keluar :‹', mediaType: 2, thumbnail: action === 'add' ? wel : lea, mediaUrl: `https://youtube.com/channel/UCiLB1Z7hJ6kXFJ35MHh96uQ`}}})
...
`.trim(), '© 𖡞Dimz вѳτż', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
